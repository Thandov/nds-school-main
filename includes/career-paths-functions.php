...
function nds_delete_career_path() {
    ...
    if ($result === false) {
        wp_die('Failed to delete career path.');
    }

    // Redirect back to course overview
    $redirect_url = admin_url('admin.php?page=nds-course-overview&course_id=' . $career_path->course_id);
