...
if (!function_exists('nds_render_education_path_form')) {
    ...
    function nds_render_education_path_form($args = array())
    {
        ...
        $edit_url = $edit_id ? admin_url('admin.php?page=nds-education-management&action=edit-path&edit=' . $edit_id) : admin_url('admin.php?page=nds-education-management');
        ?>
            ...
            <?php else: ?>
                <form method="POST" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
                            <a href="<?php echo esc_url(admin_url('admin.php?page=nds-education-management')); ?>"
