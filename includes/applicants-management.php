                    ...
                    <table class="w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tr>
                                ...
                                <?php if ($app['status'] === 'accepted'): ?>
                                                    <a href="<?php echo admin_url('admin.php?page=nds-applicants&action=convert_to_student&id=' . $app['id']); ?>"
                                ...
                                <?php endif; ?>
                                                <a href="<?php echo admin_url('admin.php?page=nds-applicants&action=delete&id=' . $app['id']); ?>"
    ...
    if ($result !== false) {
        ...
        if ($should_enroll) {
            ...
            if ($app_student) {
                ...
                // Auto-enroll student in all courses of the program they applied for
                if ($student_id > 0) {
                    // Call the enrollment function
                    nds_enroll_student_from_application($application_id, $student_id);
                }
            }
        }
