                ...
                <div class="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-5 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex gap-2">
                                                    <!-- View -->
                                                    <a href="<?php echo admin_url('admin.php?page=nds-education-management&action=edit&edit=' . $path['id']); ?>"
                                                        class="text-blue-600 hover:text-blue-700 text-xs"
                                                        title="View">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <!-- Edit -->
                                                    <a href="<?php echo admin_url('admin.php?page=nds-education-management&action=edit-path&edit=' . $path['id']); ?>"
                                                        class="text-gray-600 hover:text-gray-700 text-xs"
                                                        title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <!-- Delete -->
                                                    <a href="<?php echo admin_url('admin.php?page=nds-education-management&action=delete&delete=' . $path['id']); ?>"
                    ...
                    <?php else: ?>
                        <div class="px-5 py-12 text-center">
                            ...
                            <a href="<?php echo admin_url('admin.php?page=nds-education-management&action=add'); ?>"
