...
function nds_school_add_admin_menu() {
    ...
    add_submenu_page(
        ...
        'manage_options',
        'nds-edit-faculty',
        'nds_edit_faculty_page'  // Will use existing function or create alias
    );
...
// Alias for Faculties page (uses existing Faculties function)
if (!function_exists('nds_faculties_page')) {
    function nds_faculties_page() {
        // Use existing function - will need to update to use nds_faculties table
        nds_school_education_paths_page();
    }
}
